	...
	<el-card class="box-card">
		...
		<el-form ref="form" :rules="rules" :model="form" label-width="100px" label-position="left">
			...
			<el-form-item label="商品主图" prop="img_md">
				<Upload :url='form.img_md' :action='action' @success='handleInsertSuccess($event)' @remove='form.img_md=""'></Upload>
...
<script>
	...
	import { Province } from '@/api/index.js'
	export default {
		components: {
			Upload
		},
